...
<div class="container">
    ...
    <div class="menu-bar">
        ...
        <button onclick="toggleSection('cmd-section')">CMD Komut</button>
    ...
    <div id="upload-section" class="section">
        ...
        <form id="uploadForm" enctype="multipart/form-data" method="POST">
            ...
            <input type="submit" name="upload" value="Yükle" class="button">
        </form>
    ...
    <div id="edit-section" class="section">
        ...
        <form id="editForm" method="POST">
            ...
            <input type="submit" name="edit_file" value="Düzenle" class="button">
        </form>
    ...
    <div id="delete-section" class="section">
        ...
        <form id="deleteForm" method="POST">
            ...
            <input type="submit" name="delete_file" value="Sil" class="button">
        </form>
    ...
    <div id="cmd-section" class="section">
        ...
        <form id="cmdForm" method="POST">
            ...
            <input type="submit" value="Çalıştır" class="button">
        </form>
    ...
    <div id="download-section" class="section">
        ...
        <form id="downloadForm" method="POST">
            ...
            <input type="submit" name="download_file" value="İndir" class="button">
        </form>
    ...
    <div id="permissions-section" class="section">
        ...
        <form id="permissionsForm" method="POST">
            ...
            <input type="submit" name="file_permissions" value="İzinleri Görüntüle" class="button">
        </form>
